        ...
        <div className="lg:col-span-7 space-y-5">
          <div className="flex items-center justify-between px-2">
            <h2 className="text-xs font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
              <Clock className="w-4 h-4 text-rose-500" /> CÔNG VIỆC/DEADLINE
            </h2>
                  ...
                  {tasks.map(task => {
                    ...
                    return (
                      <div key={task.id} className={cn(
                        ...
                        isOverdue ? "bg-rose-50/40 hover:bg-rose-50/60" : "hover:bg-slate-50"
                      )}>
                        ...
                        <div className="flex-1 min-w-0 pr-4">
                          <div className="flex flex-col sm:flex-row sm:justify-between items-start sm:items-center gap-2">
                            ...
                            <div className={cn(
                              "flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider shrink-0",
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                               {task.links.filter(l => l.trim() !== '').map((link, idx) => (
                                  <a 
                                    ...
                                    className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-slate-100 hover:bg-slate-200 text-slate-600 text-[10px] font-bold rounded-md transition-colors"
                                  >
                        ...
                        <div className="flex items-center gap-2">
                           ...
                           <Link to="/tasks" className="p-2 text-slate-300 hover:text-brand-600 hover:bg-brand-50 rounded-xl transition-all" title="Xem chi tiết tại trang Danh sách">
